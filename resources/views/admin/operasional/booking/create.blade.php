...
<!-- Header Section -->
    <div class="gradient-header">
        <div class="header-left">
            <a href="{{ route('admin.operasional.booking.index') }}" class="btn-back">
            ...
            <div>
                <h2 class="header-title">Tambah booking</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.operasional.booking.index') }}">booking</a></li>
...
<form action="{{ route('admin.operasional.booking.store') }}" method="POST" id="bookingForm">
    @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="no_hp_pemesan" class="form-control @error('no_hp_pemesan') is-invalid @enderror" 
                       value="{{ old('no_hp_pemesan') }}" required>
                @error('no_hp_pemesan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="tujuan" class="form-control @error('tujuan') is-invalid @enderror" 
                       value="{{ old('tujuan') }}" placeholder="Contoh: Bandung, Yogyakarta" required>
                @error('tujuan')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="tempat_jemput" class="form-control @error('tempat_jemput') is-invalid @enderror" 
                       value="{{ old('tempat_jemput') }}" placeholder="Alamat lengkap penjemputan" required>
                @error('tempat_jemput')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="time" name="jam_berangkat" class="form-control @error('jam_berangkat') is-invalid @enderror" 
                       value="{{ old('jam_berangkat', '08:00') }}" required>
                @error('jam_berangkat')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-12">
                <div id="durasiInfo" class="alert-info-custom" style="display: none;">
                    <i class="fas fa-info-circle me-2"></i>
                    <strong>Durasi Perjalanan: <span id="durasiText">-</span></strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        ...
        <div class="alert alert-info-custom mb-3">
            <i class="fas fa-info-circle me-2"></i>
            Pilih tanggal terlebih dahulu untuk melihat bus yang tersedia
        </div>
        
        <div id="busContainer">
            <div class="text-center text-muted py-5">
                <i class="fas fa-calendar-alt fa-3x mb-3"></i>
                <p>Silakan pilih tanggal berangkat dan tanggal selesai</p>
            </div>
        </div>
    ...
    <div class="form-section">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="total_pembayaran" id="totalPembayaran" 
                           ...
                           value="{{ old('total_pembayaran', 0) }}" min="0" required>
                </div>
            ...
            <div class="col-md-6" id="nominalDpWrapper" style="display: none;">
                <label class="form-label fw-semibold">
            ...
            <div class="col-md-6">
                ...
                <select name="status_booking" class="form-select @error('status_booking') is-invalid @enderror" required>
                    <option value="draft" {{ old('status_booking', 'draft') == 'draft' ? 'selected' : '' }}>Draft</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadAvailableBuses() {
        ...
        fetch(`{{ route('admin.operasional.booking.bus-tersedia') }}?tanggal_berangkat=${tanggalBerangkat.value}&tanggal_selesai=${tanggalSelesai.value}`)
            ...
            .then(data => {
                ...
                if (data.success && data.data.length > 0) {
                    ...
                    data.data.forEach(bus => {
                        html += `
                            <div class="bus-card" onclick="toggleBus(this, ${bus.id})">
                                <input type="checkbox" name="bus_ids[]" value="${bus.id}" class="bus-card-checkbox" onclick="event.stopPropagation()">
                                <div class="bus-info">
            ...
            .catch(error => {
                ...
                busContainer.innerHTML = `
                    <div class="text-center text-danger py-5">
                        ...
                        <p>Terjadi kesalahan saat memuat data bus</p>
                    </div>
                `;
            });
    }
