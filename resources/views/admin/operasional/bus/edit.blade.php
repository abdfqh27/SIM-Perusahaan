...
<div class="admin-content">
    ...
    <div class="page-header">
        <div class="header-left">
            ...
            <div>
                <h1 class="page-title">Edit Bus</h1>
                <p class="page-subtitle">Perbarui informasi bus {{ $bu->nama_bus }}</p>
            </div>
        </div>
    ...
    <div style="
        ...
        gap: 1rem;
    ">
        <i class="fas fa-info-circle" style="font-size: 1.5rem; color: var(--blue-light);"></i>
        <div>
            <strong style="color: var(--blue-dark);">Informasi:</strong>
            <span style="color: #6c757d;">Pastikan data yang diubah sudah benar sebelum menyimpan</span>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.operasional.bus.update', $bu->id) }}" method="POST">
                @csrf
                @method('PUT')
