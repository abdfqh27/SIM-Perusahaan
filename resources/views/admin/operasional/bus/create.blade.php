...
<div class="admin-content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.operasional.bus.store') }}" method="POST" id="createBusForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <small class="form-text text-muted">
                            <i class="fas fa-info-circle"></i> Kode unik untuk identifikasi bus
                        </small>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        @enderror
                        <small class="form-text text-muted">
                            <i class="fas fa-info-circle"></i> Hanya menampilkan sopir aktif yang belum ditugaskan
                            @if($sopirs->isEmpty())
                                <span class="text-danger">(Tidak ada sopir tersedia saat ini)</span>
                            @else
                                <span class="text-success">({{ $sopirs->count() }} sopir tersedia)</span>
                            @endif
                        </small>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Form validation with SweetAlert2 + Konfirmasi
    document.getElementById('createBusForm').addEventListener('submit', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            title: 'Konfirmasi Tambah Bus',
            html: `
                <div style="text-align: left; padding: 1rem;">
                    <p>Apakah Anda yakin ingin menambahkan bus baru dengan data berikut?</p>
                    <hr>
                    ...
                    <p><strong>Nomor Polisi:</strong> ${document.getElementById('nomor_polisi').value}</p>
                </div>
            `,
            icon: 'question',
    ...
    // Session messages - HANYA TOAST NOTIFICATION
    @if(session('success'))
    Swal.fire({
        icon: 'success',
        title: 'Berhasil!',
