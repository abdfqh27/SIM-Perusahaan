...
<div class="admin-content">
    ...
    <div class="page-header">
        <div class="header-left">
            ...
            <div>
                <h1 class="page-title">Edit Sopir</h1>
                <p class="page-subtitle">Perbarui data sopir {{ $sopir->nama }}</p>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.operasional.sopir.update', $sopir) }}" method="POST">
                @csrf
                @method('PUT')
            ...
            <div style="display: flex; gap: 1rem; align-items: flex-start;">
                ...
                <div>
                    ...
                    <p style="margin: 0; color: #6c757d; line-height: 1.8;">
                        Sopir ini saat ini ditugaskan ke bus: <strong style="color: var(--blue-light);">{{ $sopir->bus->nama_bus }}</strong>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div style="display: flex; gap: 1rem; align-items: flex-start;">
                ...
                <div>
                    ...
                    <ul style="margin: 0; padding-left: 1.25rem; color: #6c757d; line-height: 1.8;">
                        ...
                        <li>Perubahan status sopir akan mempengaruhi ketersediaan dalam sistem</li>
                        <li>Jika sopir sedang bertugas, perubahan tidak akan menghapus penugasan yang ada</li>
                    </ul>
                </div>
            </div>
        </div>
